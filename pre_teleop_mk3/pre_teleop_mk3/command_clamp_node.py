...
"""
command_clamp_node.py used to smooth and clamp drive commands from MPPI planner to feasible vehicle control actions
"""
...
class CommandMuxNode(Node):
    def __init__(self) -> None:
        super().__init__("command_clamp_node")
    ...
    def cmd_callback(self, msg: AckermannDriveStamped) -> None:
        ...
        delta_out = delta_clamped
        v_out = v_clamped

        # NOTE: DEBUG LOGGING: Get planned and clamped delta
        # self.get_logger().info(
        #     f"plan delta={msg.drive.steering_angle:.3f}, clamp delta={delta_out}"
        # )
