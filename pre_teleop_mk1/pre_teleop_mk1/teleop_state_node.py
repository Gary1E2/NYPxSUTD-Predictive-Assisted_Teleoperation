...
class TeleopStateNode(Node):
    ...
    def _predict_timer(self) -> None:
        ...
        self._publish_pred(now, min_clearance, ttc_min, collision_predicted, collision_time)
    ...
    def _publish_pred(
        ...
        # ========== TELEOP CONFIDENCE ==========
        d_safe = 0.8  # meters (0.6–1.0 based on track width)
    ...
    def _publish_conservative(self, now: Time) -> None:
        ...
        """
        self._publish_pred(now, 0.0, 0.0, True, 0.0)
